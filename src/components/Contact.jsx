    ...
    return (
        <div className="w-full h-fit flex flex-col items-center justify-center relative">
            ...
            <div className="w-full h-full flex flex-col items-center justify-center gap-1 relative">
                ...
                <p className="w-[80%] text-foreground/70 text-center text-sm sm:text-base">Have questions or job opportunity? Fill out the form below, and we&apos;ll get back to you soon. Let&apos;s connect!</p>
