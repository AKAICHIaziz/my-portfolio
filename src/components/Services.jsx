    ...
    return (
        <div className="w-full h-[70vh] flex flex-col sm:w-8/12 relative mt-5">
            ...
            <div className="flex flex-col items-center gap-7">
                ...
                <h1 className="w-[98%] sm:w-full font-thin text-base sm:text-2xl text-foreground text-center">Empowering innovation through intelligent solutions and seamless development.</h1>
