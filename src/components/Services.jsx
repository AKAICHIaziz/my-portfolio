...
export default function Profile() {
    return (
        <div className="w-full h-[70vh] flex flex-col sm:w-8/12 relative mt-5">
            ...
            <div className="absolute -mb-5   sm:-mb-32 inset-0 -z-10 overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#8350e8,transparent_70%)] before:opacity-40 after:absolute after:-left-1/2 after:top-1/2 after:aspect-[1/0.7] after:w-[200%] after:rounded-[100%] after:border-t after:border-[#7876c566] after:bg-zinc-900">
                <Sparkles
                    density={1200}
            ...
            <div className="flex flex-col items-center gap-3 sm:gap-7">
                ...
                <div className="w-full flex flex-row items-center justify-center gap-10">
                    ...
                    <div className="w-[40%] cursor-pointer transition-all duration-100 hover:bg-accent/50 sm:w-[30%] h-28 sm:h-60 bg-accent/30 flex flex-col items-center justify-top gap-1 p-4 rounded-md">
                        ...
                        <p className="hidden sm:block text-foreground/70 text-center font-light text-sm sm:text-base">Building intelligent models and ML solutions to automate processes, analyze data, and enable smarter decision making.</p>
                    </div>
