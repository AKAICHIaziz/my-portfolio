    ...
    return (
        <div className="w-[90%] sm:w-[40%] h-fit rounded-lg bg-card/10 mb-1 sm:mb-20 ">
            <form action="" method="POST" className="flex flex-col items-end gap-2 p-2">
                ...
                <input type="submit" value="Submit" className="bg-primary/10 text-primary text-xs sm:text-sm font-medium w-full mt-1 rounded-md h-7 sm:h-9 flex items-center justify-center sm:w-32 cursor-pointer" />
