...
export default function LatestProjects() {
    return (
        <div className="w-10/12 flex flex-col gap-5 items-center -mt-36 sm:mt-0">

            <Link className="flex flex-row items-center justify-between w-full border-b-0 sm:border-b" href="/projects">
