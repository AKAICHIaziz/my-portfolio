...
export default function Projects() {
    return (
        ...
        <div className="w-full h-screen flex flex-col items-center pt-24 bg-skills-bg bg-cover bg-center">


            <h1 className="font-medium text-xl sm:text-4xl text-gray-400">Projects page Comming Soon</h1>
